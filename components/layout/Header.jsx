...
export default function Header() {
	return (
		<header className="flex h-[100px] items-center justify-between border-[#a59b53] border-b-[3px] bg-[linear-gradient(115deg,#063d2a,#08603f_65%,#0d5036)] px-[4.4%] text-[#eee9dc] max-[760px]:h-[79px] max-[1050px]:px-[3%] max-[760px]:px-[5%]">
			...
			>
				<Image
					className="size-[43px] object-contain max-[400px]:size-6 max-[760px]:size-8"
				...
				/>
				<Image
					className="h-auto w-[169px] object-contain max-[400px]:w-[100px] max-[760px]:w-[130px]"
			...
			<nav
				...
				className="flex shrink-0 items-center gap-6 max-[760px]:flex-col max-[760px]:items-end max-[760px]:gap-1"
			>
				<Link
					href="/medidor-de-aneis"
					className="py-2 text-sm hover:underline max-[760px]:py-1"
				>
					Medidor de anéis
				</Link>
				<Link
